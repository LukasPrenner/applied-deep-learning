...
def load_faces(file_directory):
  faces = list()
  for filename in listdir(file_directory): # iterate through all files in the directory
...
def load_dataset(file_directory):
  X, y = list(), list()
  for subdir in listdir(file_directory): # iterate through subfolders of each class
...
train_X, train_y, test_X, test_y = convert_faces_to_embeddings(train_X, train_y, test_X, test_y)

# preprocesses data
print("Preprocessing Data...")
train_X, train_y, test_X, test_y, out_encoder = preprocess_data(train_X, train_y, test_X, test_y)
